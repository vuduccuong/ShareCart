...
namespace VirtualShopping.DAL.Implement
{
    public class CartRepository : ICartRepository
    {
        ...
        public async Task<GetCartResModel> GetCartByCustomer(string customerId)
        {
           return await _context.Carts.Where(c => c.CustomerId == customerId && String.IsNullOrEmpty(c.DeliveryInformation))
                .Select(c => new GetCartResModel
                {
                    CartId = c.CartId,
                    CustomerId = c.CustomerId,
