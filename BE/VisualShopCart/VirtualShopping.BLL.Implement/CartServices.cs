...
namespace VirtualShopping.BLL.Implement
{
    public class CartServices : ICartServices
    {
        ...
        public async Task<GetCartResModel> GetCartByCustomerId(string customerId)
        {
            return await _unitOfWork.CartRepository.GetCartByCustomer(customerId).ConfigureAwait(false);
        }
    }
}